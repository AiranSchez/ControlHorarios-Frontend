<template>
  <div>
    <h1 class="flex justify-center text-4xl">{{ companyName }}</h1>
    <header class="w-full bg-indigo-light p-4 flex justify-between items-center">
    ...
    <section class="w-full p-4">
      ...
      <div class="w-full h-full border-dashed border-4 p-4 text-md" v-if= "type === 'Employees'">
        <EmployeesList/>
      </div>
