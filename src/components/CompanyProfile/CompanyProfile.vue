<template>
  <div>
    <header class="w-full bg-gray-900 p-4 flex justify-between items-center">
      ...
      <div>
        <h1 class="flex text-4xl text-white self-auto">{{ companyName }}</h1>
      </div>
    </header>
      ...
      <aside class="w-80 bg-gray shadow-md hidden sm:block">
        <div class="flex flex-col h-full justify-between p-4 bg-gray-800">
          <div class="text-sm">
           ...
           <div class="flex p-3 text-white bg-red-500 rounded cursor-pointer text-center self-end text-sm">
              <LogoutButton/>
            </div>
        </div>
      </aside>
