                ...
                <div v-for="(date, dateIndex) in no_of_days" :key="dateIndex">
                  <div style="width: 14.28%; height: 120px" class="px-4 pt-2 border-r border-b relative">
                    ...
                    <div style="height: 80px;" class="overflow-y-auto mt-1">
                      <div v-for="event in events.filter(e => new Date(e.event_date).toDateString() ===  new Date(year, month, date).toDateString() )" :key="event">
                        <div
          ...
          <div class="p-4 max-w-xl mx-auto relative absolute left-0 right-0 overflow-hidden mt-24">
            ...
            <div class="shadow w-full rounded-lg bg-white overflow-hidden w-full block p-8">
              ...
              <div class="mb-4">
                ...
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" v-model="event_title">
              </div>

              <div class="mb-4">
                <label class="text-gray-800 block mb-1 font-bold text-sm tracking-wide">Event date</label>
                <input class="bg-gray-200 appearance-none border-2 border-gray-200 rounded-lg w-full py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-white focus:border-blue-500" type="text" v-model="event_date" readonly>
              </div>
              ...
              <div class="inline-block w-64 mb-4">
                ...
                <div class="relative">
                  <select @change="event_theme = $event.target.value;" v-model="event_theme" class="block appearance-none w-full bg-gray-200 border-2 border-gray-200 hover:border-gray-500 px-4 py-2 pr-8 rounded-lg leading-tight focus:outline-none focus:bg-white focus:border-blue-500 text-gray-700">
                    <div v-for="(theme, index) in themes" :key="theme">
                      <option :value="theme.value" v-text="theme.label">{{index}}</option>
                    </div>
